        ...
        <article className="mb-[115px] ml-[60px] mt-10 h-[525px] w-[598px]">
          ...
          <div className="mt-[60px] flex">
            <div className="h-[220px] w-[327px]">
              <p className="text-left align-top text-base leading-[1.308rem] tracking-tight text-neutral-400">
            ...
            <div className="ml-5 h-[167px] w-[191px] space-y-[16px] self-end bg-white">
              ...
              <div className="flex h-[41px] w-[191px] justify-between text-left align-top">
                <div>
                  <h2 className="mb-[4px] text-base font-semibold leading-[1.308rem] text-neutral-800">
                    Conheça a Bruna
                  </h2>
                  <span className="text-xs leading-[1.308rem] text-neutral-400">
                    Ver Vídeo
                  </span>
                </div>
